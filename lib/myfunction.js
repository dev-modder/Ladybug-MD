...
// ── Extra helpers required by handler.js / BADBOI-v3 ──────────────

/** Convert number to K/M shorthand e.g. 1500 -> "1.5K" */
exports.h2k = (num) => {
...
exports.sort = (arr, key) => arr.sort((a, b) => (a[key] > b[key] ? -1 : 1))

/** Cast to number safely */
exports.toNumber = (val) => isNaN(val) ? 0 : Number(val)

/** Get enum key by value */
exports.enumGetKey = (obj, val) => Object.keys(obj).find(k => obj[k] === val)

/** Alias for sleep (ms delay) */
exports.delay = (ms) => new Promise(res => setTimeout(res, ms))

/** Pick a random element from an array */
exports.pickRandom = (arr) => arr[Math.floor(Math.random() * arr.length)]

/** Resize image buffer using Jimp */
