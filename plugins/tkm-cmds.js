// ============================================================
//  🐞 LADYBUG MD — TKM-bot Extra Commands Plugin
...
case "killgc": case "kickall": {
    ...
    try {
      ...
      await Ladybug.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 *Lord TKM* !");
...
await Ladybug.groupAcceptInvite(result).then(respon => ReplyTkm("Successfull Bergabung Ke Dalam Grup ✅")).catch(error => ReplyTkm(error.toString()))
}
break
